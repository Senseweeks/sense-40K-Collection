...
try {
    ...
    foreach ($file in @('package.json', 'preview/server.mjs', 'preview/app.jsx', 'preview/auth.mjs', 'preview/accounts.mjs', 'preview/mock-api.mjs', 'preview/index.html', 'preview/style.css', 'PyrrhicWar/PyrrhicWar.jsx', 'PyrrhicWar/PyrrhicWarMap.jsx', 'PyrrhicWar/PyrrhicWarCompendium.jsx', 'HybridCampaign/HybridCampaign.jsx', 'HybridCampaign/src/App.tsx', 'HybridCampaign/src/runtime.ts', 'HybridCampaign/server/preview-host.ts')) {
